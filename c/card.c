...
struct Hand add_card(struct Hand old_hand, struct Card card);

void print_hand(struct Hand hand);
void print_hand2(struct Hand hand);
void print_hand3(struct Hand hand);
...
void print_hand(struct Hand hand)
{
    for (int i = 1; i < hand.cards_dealt + 1; i++)
    { // 1..5
        struct Card card;

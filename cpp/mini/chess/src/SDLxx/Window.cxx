...
namespace SDLxx
{
	Window::Window(const std::string &title, int width, int height) : Window(title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height)
	{
	}

	Window::Window(const std::string &title, int x, int y, int width, int height) : Window(title, x, y, width, height, 0)
	{
	}
